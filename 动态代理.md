...
* 例如： 有 A，B，C 三个类， A 原来可以调用 C 类的方法， 现在因为某种原因 C 类不允许A 类调用其方法，但 B 类可以调用 C 类的方法。A 类通过 B 类调用 C 类的方法。这里 B 是 C的代理。 A 通过代理 B 访问 C.
  ...
  * 通过代理的访问关系：
    ...
    ![image-20241015150433966](.\image\代理访问关系.png)
...
![image-20241015154638932](.\image\代理访问关系2.png)
...
![image-20241016094908894](.\image\执行流程.png)

#### 6.2.6 类图

![image-20241016095029868](.\image\类图.png)
