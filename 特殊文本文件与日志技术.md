...
![image-20241014162102277](.\image\.properties属性文件.png)

* xml文件也可以存储数据关系。(可以表示更加复杂的用户信息。)

  ![image-20241014162133648](.\image\xml属性文件.png)
...
* 使用Properties读取属性文件里的键值对数据。
  ...
  ![image-20241014164256529](.\image\Properties类.png)
...
* XML中书写 "<" 、"&" 等，可能会出现冲突，导致报错，此时可以使用如下特殊字符代替。
  ...
  ​	![image-20241014175525002](.\image\特殊符号.png)
...
* DOM4J解析XML文件的思想：文档对象模型。![image-20241014181450758](.\image\文档对象模型.png)
